...
ResourceBlock& ResourceBlock::operator=(const ResourceBlock& other)
{
...
class ResourceBlockDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    ResourceBlockDescriptor();
    virtual ~ResourceBlockDescriptor();
...
Register_ClassDescriptor(ResourceBlockDescriptor)

ResourceBlockDescriptor::ResourceBlockDescriptor() : omnetpp::cClassDescriptor("ResourceBlock", "omnetpp::cPacket")
{
    propertynames = nullptr;
}

ResourceBlockDescriptor::~ResourceBlockDescriptor()
{
    delete[] propertynames;
}

bool ResourceBlockDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<ResourceBlock *>(obj)!=nullptr;
}

const char **ResourceBlockDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *ResourceBlockDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *ResourceBlockDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *ResourceBlockDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int ResourceBlockDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *ResourceBlockDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string ResourceBlockDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool ResourceBlockDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *ResourceBlockDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *ResourceBlockDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
